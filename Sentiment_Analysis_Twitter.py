...
def prepare_data():
    ...
    return padded_train_sen, train_labels, padded_test_sen, test_labels, vocab_size, embedding_matrix
        
    
def model(padded_train_sen, train_labels, padded_test_sen, test_labels, vocab_size, embedding_matrix):
    ...
    print('Model1 Accuracy: %f' % (accuracy*100))
    ...
    loss, accuracy = model.evaluate(padded_test_sen, test_labels, verbose=1)
    print('Model2 Accuracy: %f' % (accuracy*100))

padded_train_sen, train_labels, padded_test_sen, test_labels, vocab_size, embedding_matrix = prepare_data()
model(padded_train_sen, train_labels, padded_test_sen, test_labels, vocab_size, embedding_matrix)
